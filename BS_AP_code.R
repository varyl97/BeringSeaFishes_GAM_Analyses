...
apsub<-read.csv(file='Cleaned_Cut_ApEggs.csv',header=TRUE,check.names=TRUE)
apsub.ctd<-read.csv(file='Cleaned_Cut_ApEggs_wCTD.csv',header=TRUE,check.names=TRUE)
aplarv<-read.csv(file='Cleaned_Cut_ApLarv.csv',header=TRUE,check.names=TRUE)
aplarv.ctd<-read.csv(file='Cleaned_Cut_ApLarv_wCTD.csv',header=TRUE,check.names=TRUE)
