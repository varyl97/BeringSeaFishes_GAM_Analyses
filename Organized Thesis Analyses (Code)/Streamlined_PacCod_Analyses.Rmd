...
tmp2<-sort(unique(pcylarv$yearbin))

pcyl1<-pcylpos[pcylpos$yearbin==tmp2[[1]],]
pcylz1<-pcylz[pcylz$yearbin==tmp2[[1]],]

pcyl2<-pcylpos[pcylpos$yearbin==tmp2[[2]],]
pcylz2<-pcylz[pcylz$yearbin==tmp2[[2]],]

pcyl3<-pcylpos[pcylpos$yearbin==tmp2[[3]],]
pcylz3<-pcylz[pcylz$yearbin==tmp2[[3]],]

pcyl4<-pcylpos[pcylpos$yearbin==tmp2[[4]],]
pcylz4<-pcylz[pcylz$yearbin==tmp2[[4]],]
```
...
yearl1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  ...
  geom_point(data=pcylz1,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pcyl1,aes(x=lon,y=lat,size=logcpue),
  ...
  labs(title="Pacific Cod Sole Larvae, 1997-2002")+ylab("Latitude")+xlab("Longitude")
...
yearl2<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pcylz2,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pcyl2,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl3<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pcylz3,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pcyl3,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl4<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pcylz4,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pcyl4,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
