...
apcol<-adjustcolor('#93499F',alpha.f=0.6)
...
DrawEllipse(x=31.5,y=6.35,radius.x=0.5,radius.y=1.15,rot=0, border='grey69',col='#410E48')#x axis = salinity, y axis = temperature
DrawEllipse(x=31.4,y=5,radius.x=0.4,radius.y=0.5,rot=0,border='grey69',col=apcol)
DrawEllipse(x=32,y=5,radius.x=1,radius.y=1,rot=0,border='grey69',col=pkcol)
DrawEllipse(x=30.75,y=9.75,radius.x=0.75,radius.y=0.75,border='grey69',col='#EBE6EC')
DrawEllipse(x=31.75,y=2.5,radius.x=0.75,radius.y=2,border='grey69',col='#CFECCF')
DrawEllipse(x=31,y=6.625,radius.x=0.75,radius.y=0.875,border='grey69',col='#7CBF7C')
legend('bottomleft',legend=c('Flathead Sole','Alaska Plaice','Walleye Pollock','Yellowfin Sole',
                              'Northern Rock Sole','Pacific Cod'),col=c('#410E48','#93499F','#BFA0C6','#EBE6EC','#CFECCF','#7CBF7C'),
       bg='snow1',pch=16)
