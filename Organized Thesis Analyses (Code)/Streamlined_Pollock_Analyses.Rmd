...
tmp1<-sort(unique(pkysub$yearbin))

pky1<-pkypos[pkypos$yearbin==tmp1[[1]],]
pkz1<-pkyz[pkyz$yearbin==tmp1[[1]],]

pky2<-pkypos[pkypos$yearbin==tmp1[[2]],]
pkz2<-pkyz[pkyz$yearbin==tmp1[[2]],]

pky3<-pkypos[pkypos$yearbin==tmp1[[3]],]
pkz3<-pkyz[pkyz$yearbin==tmp1[[3]],]

pky4<-pkypos[pkypos$yearbin==tmp1[[4]],]
pkz4<-pkyz[pkyz$yearbin==tmp1[[4]],]

pky5<-pkypos[pkypos$yearbin==tmp1[[5]],]
pkz5<-pkyz[pkyz$yearbin==tmp1[[5]],]

pky6<-pkypos[pkypos$yearbin==tmp1[[6]],]
pkz6<-pkyz[pkyz$yearbin==tmp1[[6]],]

pky7<-pkypos[pkypos$yearbin==tmp1[[7]],]
pkz7<-pkyz[pkyz$yearbin==tmp1[[7]],]

pky8<-pkypos[pkypos$yearbin==tmp1[[8]],]
pkz8<-pkyz[pkyz$yearbin==tmp1[[8]],]
...
year1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  ...
  geom_point(data=pkz1,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky1,aes(x=lon,y=lat,size=logcpue),
  ...
  labs(title="Pollock Eggs, 1979-1984",shape="Log (CPUE + 1)")+ylab("Latitude")+xlab("Longitude")
...
year2<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz2,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky2,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
year3<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz3,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky3,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
year4<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz4,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky4,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
year5<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz5,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky5,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
year6<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz6,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky6,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
year7<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz7,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky7,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
year8<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkz8,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pky8,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE + 1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
tmp2<-sort(unique(pkylarv$yearbin))

pkyl1<-pkylpos[pkylpos$yearbin==tmp2[[1]],]
pkylz1<-pkylz[pkylz$yearbin==tmp2[[1]],]

pkyl2<-pkylpos[pkylpos$yearbin==tmp2[[2]],]
pkylz2<-pkylz[pkylz$yearbin==tmp2[[2]],]

pkyl3<-pkylpos[pkylpos$yearbin==tmp2[[3]],]
pkylz3<-pkylz[pkylz$yearbin==tmp2[[3]],]

pkyl4<-pkylpos[pkylpos$yearbin==tmp2[[4]],]
pkylz4<-pkylz[pkylz$yearbin==tmp2[[4]],]
```
...
yearl1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth (m)",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkylz1,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pkyl1,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        ...
        legend.text=element_text(size=8))+
  scale_shape_manual(values=('No Catch'=8))+
  labs(title="Pollock Larvae, 1997-2002")+ylab("Latitude")+xlab("Longitude")

yearl2<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkylz2,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pkyl2,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl3<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkylz3,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pkyl3,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl4<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=pkylz4,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=pkyl4,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
