...
tmp2<-sort(unique(yfylarv$yearbin))

yfyl1<-yfylpos[yfylpos$yearbin==tmp2[[1]],]
yfylz1<-yfylz[yfylz$yearbin==tmp2[[1]],]

yfyl2<-yfylpos[yfylpos$yearbin==tmp2[[2]],]
yfylz2<-yfylz[yfylz$yearbin==tmp2[[2]],]

yfyl3<-yfylpos[yfylpos$yearbin==tmp2[[3]],]
yfylz3<-yfylz[yfylz$yearbin==tmp2[[3]],]

yfyl4<-yfylpos[yfylpos$yearbin==tmp2[[4]],]
yfylz4<-yfylz[yfylz$yearbin==tmp2[[4]],]
```
...
yearl1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  ...
  geom_point(data=yfylz1,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=yfyl1,aes(x=lon,y=lat,size=logcpue),
  ...
  labs(title="Yellowfin Sole Larvae, 1997-2002")+ylab("Latitude")+xlab("Longitude")
...
yearl2<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=yfylz2,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=yfyl2,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl3<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=yfylz3,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=yfyl3,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl4<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=yfylz4,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=yfyl4,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
