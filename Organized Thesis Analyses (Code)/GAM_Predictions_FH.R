...
# Calculate Differences Due to Different Temperature Regimes --------
...
grid.extent<-data.frame('lon'=rep(-155,100),'lat'=rep(52,100),'doy'=seq(min(fhsub$doy),max(fhsub$doy),length=100),
