...
tmp2<-sort(unique(nrsylarv$yearbin))

nrsyl1<-nrsylpos[nrsylpos$yearbin==tmp2[[1]],]
nrsylz1<-nrsylz[nrsylz$yearbin==tmp2[[1]],]

nrsyl2<-nrsylpos[nrsylpos$yearbin==tmp2[[2]],]
nrsylz2<-nrsylz[nrsylz$yearbin==tmp2[[2]],]

nrsyl3<-nrsylpos[nrsylpos$yearbin==tmp2[[3]],]
nrsylz3<-nrsylz[nrsylz$yearbin==tmp2[[3]],]

nrsyl4<-nrsylpos[nrsylpos$yearbin==tmp2[[4]],]
nrsylz4<-nrsylz[nrsylz$yearbin==tmp2[[4]],]
```
...
yearl1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  ...
  geom_point(data=nrsylz1,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=nrsyl1,aes(x=lon,y=lat,size=logcpue),
  ...
  labs(title="Northern Rock Sole Larvae, 1997-2002")+ylab("Latitude")+xlab("Longitude")
...
yearl2<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=nrsylz2,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=nrsyl2,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl3<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=nrsylz3,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=nrsyl3,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
...
yearl4<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=nrsylz4,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=nrsyl4,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
