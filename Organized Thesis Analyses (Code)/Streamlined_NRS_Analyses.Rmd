...
aic.nrslarv<-data.frame('model'=c('Base','Add Sal','Add Temp',
...
plot(c(1:5),aic.nrslarv$AIC_value,main='NRS',
     col=hcl.colors(5,"Zissou 1"),
     pch=19,cex=2,ylab='AIC Score',xlab='')
grid(nx=5,ny=14,col="lightgray")
text(c(1:5),aic.nrslarv$AIC_value,labels=round(aic.nrslarv$AIC_value),pos=c(4,1,3,2,2))
...
#write.csv(grid.clip,'Nrs_larv_clip_60.csv')
```

So this percentage (percbi, 42.6%) is the percentage of the total grid extent within which 60% of the predicted log(CPUE+1) lies. I.e., 42.6% percent of the whole grid extent encompasses 60% of the predicted observations. 
...
bivar<-ggplot(grid.clip)+geom_tile(aes(x=salinity,y=temperature,fill=pred))+theme_bw()+
  ...
  geom_vline(xintercept=31.25,linetype="solid",color="grey48")+
  geom_vline(xintercept=31,linetype="twodash",color="grey48")+
  geom_vline(xintercept=30,linetype="longdash",color="grey48")+
  geom_vline(xintercept=31.75,linetype="dotted",color="grey48")+
  geom_vline(xintercept=32,linetype="dotdash",color="grey48")+
  geom_hline(yintercept=5.5,linetype="dashed",color="black")+
  geom_hline(yintercept=5.75,linetype="solid",color="grey48")+
  geom_hline(yintercept=5.25,linetype="twodash",color="grey48")+
  geom_hline(yintercept=4.75,linetype="longdash",color="grey48")+
  geom_hline(yintercept=4,linetype="dotted",color="grey48")+
  geom_hline(yintercept=3.5,linetype="dotdash",color="grey48")+
...
71.2% of the salinity-temperature area contains 60% of the total predicted log(CPUE+1). 
