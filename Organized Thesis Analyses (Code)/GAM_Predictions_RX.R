...
plot(eg.base,select=2,main='Rex Sole Base Phenology, Eggs',
     seWithMean=TRUE,xlab='Day of Year',ylab='Anomalies (edf: 6.584)',ylim=c(-2,2.5))
...
plot(thr.geo,select=1,main='Rex Sole Threshold Geo Phenology, Eggs',
     seWithMean=TRUE,xlab='Day of Year',ylab='Anomalies (edf: 7.75)',ylim=c(-2,2.5))
abline(h=0,col='mistyrose4',lty=2,lwd=1.3)
...
plot(thr.geo,select=1,seWithMean=TRUE,shade=TRUE,shade.col=col,ylim=c(-2,2.5))
