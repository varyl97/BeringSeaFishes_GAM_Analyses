...
windows()
plot(c(1:5),aic.pclarv$AIC_value,main='AIC Results for PC Larvae Models',
     col=c( "#482173FF", "#38598CFF","#1E9B8AFF", "#51C56AFF","#FDE725FF"),
     pch=19,cex=2,ylab='AIC Value',xlab='')
grid(nx=5,ny=14,col="lightgray")
text(c(1:5),aic.pclarv$AIC_value,labels=round(aic.pclarv$AIC_value),pos=c(4,1,3,3,2))
...
saveRDS(lv.add.sal,"./GAM Models/pc_larvae_addsal.rds")
saveRDS(lv.add.temp,"./GAM Models/pc_larvae_addtemp.rds")
saveRDS(lv.temp.sal,"./GAM Models/pc_larvae_addtempsal.rds")
saveRDS(lv.2d,"./GAM Models/pc_larvae_2d.rds")
