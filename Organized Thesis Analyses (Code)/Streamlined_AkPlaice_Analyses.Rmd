...
year1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  ...
  labs(title="Plaice Eggs, 1979-1984",shape="Log (CPUE + 1)")+ylab("Latitude")+xlab("Longitude")
...
tmp2<-sort(unique(apylarv$yearbin))

apyl1<-apylpos[apylpos$yearbin==tmp2[[1]],]
apylz1<-apylz[apylz$yearbin==tmp2[[1]],]

apyl2<-apylpos[apylpos$yearbin==tmp2[[2]],]
apylz2<-apylz[apylz$yearbin==tmp2[[2]],]

apyl3<-apylpos[apylpos$yearbin==tmp2[[3]],]
apylz3<-apylz[apylz$yearbin==tmp2[[3]],]

apyl4<-apylpos[apylpos$yearbin==tmp2[[4]],]
apylz4<-apylz[apylz$yearbin==tmp2[[4]],]
```
...
yearl1<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth (m)",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=apylz1,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=apyl1,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        ...
        legend.text=element_text(size=8))+
  scale_shape_manual(values=('No Catch'=8))+
  labs(title="Plaice Larvae, 1997-2002")+ylab("Latitude")+xlab("Longitude")

yearl2<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=apylz2,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=apyl2,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        ...
        legend.text=element_text(size=8))+
  scale_shape_manual(values=('No Catch'=8))+
  labs(title="Plaice Larvae, 2003-2007")+ylab("Latitude")+xlab("Longitude")

yearl3<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=apylz3,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=apyl3,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        ...
        legend.text=element_text(size=8))+
  scale_shape_manual(values=('No Catch'=8))+
  labs(title="Plaice Larvae, 2008-2012")+ylab("Latitude")+xlab("Longitude")

yearl4<-autoplot.bathy(bathybath,geom=c("contour","raster"),coast=TRUE,color="grey")+
  scale_fill_gradientn("Depth",values=scales::rescale(c(-7600,0,1,2321)),
                       colors=c("steelblue4","#C7E0FF","grey50","grey80"))+
  geom_point(data=apylz4,aes(x=lon,y=lat),fill="violetred4",shape=8)+
  geom_point(data=apyl4,aes(x=lon,y=lat,size=logcpue),
                               fill="#993300",shape=21,alpha=0.8)+
  scale_size_continuous("Log (CPUE+1)",range=c(0,9),breaks=pretty_breaks(9))+
  theme(panel.grid.major=element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        ...
        legend.text=element_text(size=8))+
  scale_shape_manual(values=('No Catch'=8))+
  labs(title="Plaice Larvae, 2013-2016")+ylab("Latitude")+xlab("Longitude")
```
