...
fhlarv.ctd<-subset(fhlarv.ctd,doy>100&doy<165)
...
This is the below threshold (2.29 deg C) and above threshold temporal distribution of flathead eggs (based on the threshold phenology model). 
