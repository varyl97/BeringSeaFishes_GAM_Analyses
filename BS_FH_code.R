...
fhsub<-read.csv(file='Cleaned_Cut_FhEggs.csv',header=TRUE,check.names=TRUE)
fhsub.ctd<-read.csv(file='Cleaned_Cut_FhEggs_wCTD.csv',header=TRUE,check.names=TRUE)
fhlarv<-read.csv(file='Cleaned_Cut_FhLarv.csv',header=TRUE,check.names=TRUE)
